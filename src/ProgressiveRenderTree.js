define([], function() {
     ...
     * find the highest available geometry resolution and falls back to coarser geoemetry level, if necessary.
     */
    var ProgressiveRenderTree = function() {}

    ProgressiveRenderTree.prototype.buildFromTiles = function(tiles) {
    ...
    ProgressiveRenderTree.prototype._determineRenderNodes = function(start_tile, container) {
    ...
    ProgressiveRenderTree.prototype._sortTiles = function(tiles) {
    ...
    ProgressiveRenderTree.prototype._hasGeometryLoaded = function(tile) {
    ...
    ProgressiveRenderTree.prototype._getRootNode = function(tile) {
        if (tile.extension.sgExtension) {
    ...
    ProgressiveRenderTree.prototype._getLevel0Tile = function(tile) {
        if (tile.parent) {
